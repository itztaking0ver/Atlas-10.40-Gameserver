...
namespace UC
{
	...
	namespace ContainerImpl
	{
		...
		public:
			SetElement() : HashNextId(-1), HashIndex(-1) {}

			SetElement(const SetType& InValue)
				: Value(InValue), HashNextId(-1), HashIndex(-1) {
			}

			inline       SetType& GetValue() { return Value; }
			inline const SetType& GetValue() const { return Value; }
		};
	...
	public:
		static __forceinline void* InternalRealloc(void* _a1, __int64 _a2, unsigned int _a3) {
			return ((void *(*)(void*, __int64, unsigned int)) Runtime::Offsets::Realloc)(_a1, _a2, _a3);
		}
	...
	FORCEINLINE	 void _TArrayAdd(void*& Data, int32& NumElements, int32& MaxElements, int32 _Elem_Sz, const void* Element)
	{
	...
	public:
		...
		FString(xstring Str)
		: FString(xwstring(Str.begin(), Str.end()).c_str())
		{
		}
...
#pragma warning(suppress: 4244)
		...
		inline xstring ToStringX() const
		{
			if (*this)
			{
				xwstring WData(Data);
				#pragma warning(suppress: 4244)
				return xstring(WData.begin(), WData.end());
			}
	...
	*/
	...
	public: // 👈 move it out of private
		using FElementOrFreeListLink = ContainerImpl::TSparseArrayElementOrFreeListLink<
			ContainerImpl::TAlignedBytes<sizeof(SparseArrayElementType), alignof(SparseArrayElementType)>
		>;
	public:
	...
	public:
		...
		inline const SparseArrayElementType& operator[](int32 Index) const { return *reinterpret_cast<const SparseArrayElementType*>(&Data.GetUnsafe(Index).ElementData); }
	...
	public:
		SetElementType& Add(const SetElementType& InValue)
		{
			// Wrap the raw element
			SetDataType Wrapper(InValue);

			// Store it into sparse array
			Elements.Data.Add(reinterpret_cast<typename TSparseArray<SetDataType>::FElementOrFreeListLink&>(Wrapper));

			// Mark allocation
			Elements.AllocationFlags.Set(Elements.Data.Num() - 1, true);

			// Return reference to value
			return Elements[Elements.Data.Num() - 1].GetValue();
		}
	...
	public:
		...
		void Add(const KeyElementType& Key, const ValueElementType& Value)
		{
			...
			Elements.Add(ElementType(Key, Value));
		}
